...
function Privacy() {
  return (
    <div className="container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Dhoom Dhamaka, 29 A, Lakshmi Aman Kovil
            street, Puthagram, Chennai - 600 099..
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Dhoom Dhamaka, accessible from{" "}
            <a
      ...
      <ul>
        <li>By email: dhoomdhamaka0@gmail.com</li>
      </ul>
    </div>
  );
}
