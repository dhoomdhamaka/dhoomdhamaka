...
function Privacy() {
  return (
    <div className="row justify-content-center min-vh-100">
      <div className="col-md-10 mb-4 mt-3 bg-light">
        <div className="card shadow-4-strong rounded-4">
          <div className=" card-body mx-xl-5">
            <h2
              className={
                "fw-bold border-bottom border-danger pb-1 text-center mb-4"
              }
              style={{ fontSize: "45px", fontVariant: "small-caps" }}
            >
              Privacy Policy
            </h2>
            <p className=" text-muted mb-2">Last updated: 20 September 2022</p>
            <p className="ms-3">
            ...
            <h2 class="subHeadPvcH2 fw-bold my-2">
              Interpretation and Definitions
            </h2>
            <h3 class="subHeadPvc fw-bold mb-2">Interpretation</h3>
            <p className="ms-3">
            ...
            <h3 class="fw-bold my-2">Definitions</h3>
            <p className="ms-3">For the purposes of this Privacy Policy:</p>
            <ul className="ms-4 mb-3">
              ...
              <li>
                <p>
                  ...
                  Company&#x27;, &#x27;We&#x27;, &#x27;Us&#x27; or
                  &#x27;Our&#x27; in this Agreement) refers to Dhoom Dhamaka.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Dhoom Dhamaka, accessible
                  from{" "}
                  <a
                    href="dhoomdhamaka.com"
            ...
            <h2 class="subHeadPvcH2 mb-2 fw-bold">
              Collecting and Using Your Personal Data
            </h2>
            <h3 class="subHeadPvc fw-bold mb-2">Types of Data Collected</h3>
            <h3 class="subHeadPvc fw-bold">Personal Data</h3>
            <p className="ms-3">
            ...
            <h3 class="fw-bold my-2">Usage Data</h3>
            <p className="ms-3">
            ...
            <h3 class="fw-bold my-2">Tracking Technologies and Cookies</h3>
            <p className="ms-3">
            ...
            <ul className="ms-4">
              ...
              <li>
                ...
                <a
                  href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_or_deleting_local_shared_objects_"
                  rel="external nofollow noopener noreferrer"
                  target="_blank"
                >
            ...
            <h3 className="fw-bold my-2">Use of Your Personal Data</h3>
            <p className="ms-3">
            ...
            <h3 className="fw-bold my-2">Retention of Your Personal Data</h3>
            <p className="ms-3">
            ...
            <h3 className="fw-bold my-2">Transfer of Your Personal Data</h3>
            <p className="ms-3">
            ...
            <h3 class="subHeadPvc fw-bold my-2">Business Transactions</h3>
            <p className="ms-3">
            ...
            <h3 className="fw-bold my-2">Law enforcement</h3>
            <p className="ms-3">
            ...
            <h3 className="fw-bold my-2">Other legal requirements</h3>
            <p className="ms-3">
            ...
            <h3 className="fw-bold my-2">Security of Your Personal Data</h3>
            <p className="ms-3">
            ...
            <h3 className="fw-bold my-2">Links to Other Websites</h3>
            <p className="ms-3">
            ...
            <h3 className="fw-bold my-2">Changes to this Privacy Policy</h3>
            <p className="ms-3">
            ...
            <h3 className="fw-bolder border-top pt-2 border-danger my-2">
              Contact Us
            </h3>
            <p className="ms-3 ">
