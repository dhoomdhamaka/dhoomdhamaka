  ...
  return (
    <div className="mb-10 mt-5" style={{ minHeight: "80vh" }}>
      ...
      {display === "wedding" && (
        <Weddinginfo
          wedding={infoDetail}
          personalwedding={eventDetail}
          name={name}
        />
      )}
      {display === "prewed" && (
        <Preweddinginfo
          prewedding={infoDetail}
          personalprewedding={eventDetail}
          name={name}
        />
      )}
      {display === "postwed" && (
        <Postweddinginfo
          postwedding={infoDetail}
          personalpostedding={eventDetail}
          name={name}
        />
      )}
      {display === "engagement" && (
        <Engagementinfo
          engagement={infoDetail}
          personalengagement={eventDetail}
          name={name}
        />
      )}
      {display === "corp" && (
        <Corporateinfo
          corporate={infoDetail}
          personalcorporate={eventDetail}
          name={name}
        />
      )}
      {display === "family" && (
        <Familyfunctioninfo
          familyfunction={infoDetail}
          personalfamily={eventDetail}
          name={name}
        />
      )}
      {display === "babyshower" && (
        <Babyshowerinfo
          babyshower={infoDetail}
          personalbabyshower={eventDetail}
          name={name}
        />
      )}
      {display === "birthday" && (
