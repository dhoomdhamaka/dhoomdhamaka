    ...
    <div class="container mt-5">
      <div class="row d-flex ">
        <div class="col-md-6">
          <div class="card" style={{ minHeight: "60vh" }}>
            ...
            <div class="text-center mt-4">
              {" "}
              <small class="text-uppercase flat fw-bold text-success ">
                Points you earned for your next order{" "}
              </small>{" "}
            </div>
            <hr class="my-5" />
            ...
            <div class="d-flex justify-content-center px-2">
              <div class="d-flex flex-row">
                <h1 class="mt-0 off fw-bold text-black">{points}</h1>{" "}
        ...
        <div class="col-md-6">
          <div class="card">
            <img
              src="https://media.istockphoto.com/photos/girl-holds-tickets-boarding-passes-for-a-flight-picture-id1363169212?b=1&k=20&m=1363169212&s=170667a&w=0&h=V4zz5xXMbOAmqazvFnpQj4HqSx9YRh_apaI2dEgsTI4="
              className="card-img"
            />
            ...
            <div class="text-center mt-4 ">
              {" "}
              <small class="text-uppercase flat fw-bold text-success">
                Vouchers you earned for your next order{" "}
              </small>{" "}
            </div>
            <hr class="my-5" />
            ...
            <div class="d-flex justify-content-center px-2">
              <div class="d-flex flex-row">
                <h1 class="mt-0 off fw-bold text-black">{voucher}</h1>{" "}
                <sup class="mt-2 text-primary star">*</sup>
              </div>
            </div>
            <div class="line"></div>
