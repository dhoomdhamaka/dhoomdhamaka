...
function InvoiceDetails(props) {
  ...
  return (
    <div>
      <div className="row justify-content-center my-md-4 my-xl-5">
        <div className="col-md-8 my-xl-5 my-md-4">
          <div class="card">
                ...
                <div class="row">
                  ...
                  >
                    ...
                    >
                      Total :
                      <span>
                        <i class="fas fa-indian-rupee-sign ms-2"></i>{" "}
                        {totalCharge}
                      </span>
                    </p>
                  </div>
                ...
                <div class="row mt-4 mb-2">
                  <p class="fw-bold text-center">
                    <span class="text-muted">
                      ...
                      <span className="fw-bolder">Dhoom Dhamaka</span>{" "}
                    </span>
                  </p>
