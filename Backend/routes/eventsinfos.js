...
const {
  CorporateEventForm,
  CorporateInfo,
} = require("../model/corporateEvent");
const {
  FamilyFunctionForm,
  FamilyFunctionInfo,
} = require("../model/familyFunction");
...
router.post("/babyshowercancel/:userId", (req, res) => {
  BabyShowerForm.findOneAndUpdate(
...
router.post("/babyaccepted/:userId", (req, res) => {
  BabyShowerForm.findOneAndUpdate(
    { orderId: req.params.userId },
    { $set: { cancelstatus: "Accepted", canceled: true } },
    (err, doc) => {
      if (err) {
        console.log(err);
        res.status(400).send(err);
...
router.post("/corporatecancel/:userId", (req, res) => {
  CorporateEventForm.findOneAndUpdate(
    { orderId: req.params.userId },
    { $set: { cancelrequest: true } },
    (err, doc) => {
      if (err) {
...
router.post("/engagementcancel/:userId", (req, res) => {
  EngagementForm.findOneAndUpdate(
    { orderId: req.params.userId },
    { $set: { cancelrequest: true } },
    (err, doc) => {
      if (err) {
...
router.post("/familyfunctioncancel/:userId", (req, res) => {
  FamilyFunctionForm.findOneAndUpdate(
    { orderId: req.params.userId },
    { $set: { cancelrequest: true } },
    (err, doc) => {
      if (err) {
...
router.post("/postweddingcancel/:userId", (req, res) => {
  PostWeddingForm.findOneAndUpdate(
    { orderId: req.params.userId },
    { $set: { cancelrequest: true } },
    (err, doc) => {
      if (err) {
...
router.post("/preweddingcancel/:userId", (req, res) => {
  PreWeddingForm.findOneAndUpdate(
    { orderId: req.params.userId },
    { $set: { cancelrequest: true } },
    (err, doc) => {
      if (err) {
...
router.delete("/babydlt/:orderId", (req, res) => {
  ...
  EventName.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      console.log(err);
    } else {
      console.log("Invoice Deleted BBy");
  ...
  PaymentfullDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("payment Deleted BBy");
    }
  });
...
router.delete("/birthdaydlt/:orderId", (req, res) => {
  ...
  InvoiceDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("Invoice Deleted BDy");
    }
  });
  EventName.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
  ...
  PaymentfullDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("payment Deleted BDy");
    }
  });
...
router.delete("/corporatedlt/:orderId", (req, res) => {
  ...
  InvoiceDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("Invoice Deleted corp");
    }
  });
  EventName.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
  ...
  PaymentfullDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("payment Deleted corp");
    }
  });
...
router.delete("/engagementdlt/:orderId", (req, res) => {
  ...
  InvoiceDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("Invoice Deleted engage");
    }
  });
  PaymentfullDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("payment Deleted engage");
    }
  });
...
router.delete("/familyfunctiondlt/:orderId", (req, res) => {
  ...
  InvoiceDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("Invoice Deleted fam");
    }
  });
  EventName.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
  ...
  PaymentfullDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("payment Deleted fam");
    }
  });
...
router.delete("/postweddingdlt/:orderId", (req, res) => {
  ...
  InvoiceDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("Invoice Deleted postwed");
    }
  });
  EventName.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
  ...
  PaymentfullDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("payment Deleted postwed");
    }
  });
...
router.delete("/preweddingdlt/:orderId", (req, res) => {
  ...
  InvoiceDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("Invoice Deleted prewed");
    }
  });
  EventName.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
  ...
  PaymentfullDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("payment Deleted prewed");
    }
  });
...
router.delete("/weddingdlt/:orderId", (req, res) => {
  ...
  InvoiceDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("Invoice Deleted wed");
    }
  });
  EventName.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
  ...
  PaymentfullDhoom.remove({ orderId: req.params.orderId }, (err, doc) => {
    if (err) {
      ...
      console.log("payment Deleted wed");
    }
  });
